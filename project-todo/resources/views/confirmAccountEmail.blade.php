    ...
    <tr>
        <td>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-2"
                   role="presentation"
                   style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #fff; background-position: top center;"
                   width="100%">
                <tbody>
                <tr>
                    <td>
                                ...
                                <td class="column"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px;">
                                                            <strong><span style="font-size:38px;">One
																					more step to finish your
																					first todo {{$name}}</span></strong>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        ...
                                                        <p style="margin: 0; font-size: 14px;"><span
                                                                style="font-size:16px;">Hey, we noticed
																				you just created an account.</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div style="font-family: sans-serif">
                                                    <div
                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                        <p style="margin: 0; font-size: 14px;"><span
                                                                style="font-size:16px;">Let’s activate
																				it!</span></p>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tr>
                                            ...
                                            <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$activation}}" style="height:48px;width:212px;v-text-anchor:middle;" arcsize="34%" stroke="false" fillcolor="#506bec"><w:anchorlock/><v:textbox inset="5px,0px,0px,0px"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:15px"><![endif]--><a
                                                    href="{{$activation}}"
                                                    ...
                                                    target="_blank"><span
                                                        style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
                                                            style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                ...
                                                                style="font-size: 15px; line-height: 30px;"><strong>ACTIVATE
																					MY
																					ACCOUNT</strong></span></span></span></a>
